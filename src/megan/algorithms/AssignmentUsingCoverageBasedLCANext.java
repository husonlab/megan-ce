 ...
 */
public class AssignmentUsingCoverageBasedLCANext implements IAssignmentAlgorithm {
    private final float weightedPercent;
     ...
     * constructor
     */
    public AssignmentUsingCoverageBasedLCANext(Document doc) {
        this.weightedPercent = doc.getWeightedLCAPercent();
    ...
    public int computeId(BitSet activeMatches, IReadBlock readBlock) {
        ...
        final double threshold = (weightedPercent / 100.0) * node2covered.get(root);
