...
public class AttributesList extends LabelsJList {
    ...
    public AttributesList(final ChartViewer viewer) {
        ...
        chartSelection.addAttributesSelectionListener(new IChartSelectionListener() {
    ...
    private static PopupMenu createPopupMenu(ChartViewer viewer) {
        return new PopupMenu(GUIConfiguration.getAttributesListPopupConfiguration(), viewer.getCommandManager(), false);
    }
}
