/*
 * SetAnalyseCommand.java Copyright (C) 2023 Daniel H. Huson
 *
...
public class SetAnalyseCommand extends CommandBase implements ICommand {
    ...
    public void apply(NexusStreamParser np) throws Exception {
        ...
        String cName = np.getWordMatchesRespectingCase(StringUtils.toString(ClassificationManager.getAllSupportedClassifications(), " "));
