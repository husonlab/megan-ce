...
public class ShowGroupsCommand extends CommandBase implements ICheckBoxCommand {
    ...
    public boolean isSelected() {
        ...
        return viewer.getPcoaTab() != null && viewer.getPcoaTab().isShowGroups();
    }
    ...
    public void apply(NexusStreamParser np) throws Exception {
        ...
        viewer.getPcoaTab().setShowGroups(show);
        try {
            if (show)
    ...
    public String getSyntax() {
        return "set showGroups={false|true};";
    }
    ...
    public String getDescription() {
        return "Show groups using convex hull";
    }
    ...
    public void actionPerformed(ActionEvent ev) {
        executeImmediately("set showGroups=" + (!isSelected()) + ";");
    }
