/*
 * SetLabelFillColorCommand.java Copyright (C) 2024 Daniel H. Huson
 *
 ...
 * Daniel Huson, 4.2011
 */
public class SetLabelFillColorCommand extends CommandBase implements ICommand {
    ...
    public void actionPerformed(ActionEvent ev) {
        ...
        if (color != null)
            execute("set labelFillColor=" + color.getRed() + " " + color.getGreen() + " " + color.getBlue() + ";");
    }
    ...
    public String getSyntax() {
        return "set labelFillColor={<color>|null};";
    }
