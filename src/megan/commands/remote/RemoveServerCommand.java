/*
 * RemoveServerCommand.java Copyright (C) 2020. Daniel H. Huson
 *
...
public class RemoveServerCommand extends CommandBase implements ICommand {
    public String getSyntax() {
        return "remoteServer url=<url>;";
    }

    public void apply(NexusStreamParser np) throws Exception {
        np.matchIgnoreCase("addServer url=");
        String url = np.getWordFileNamePunctuation();
        np.matchIgnoreCase(";");
        RemoteServiceManager.ensureCredentialsHaveBeenLoadedFromProperties();
        RemoteServiceManager.removeCredentials(url);
    }
