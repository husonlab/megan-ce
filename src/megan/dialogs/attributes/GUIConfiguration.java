...
public class GUIConfiguration {
    ...
    public static MenuConfiguration getMenuConfiguration() {
        ...
        menuConfig.defineMenuBar("File;Edit;View;Window;Help;");

        menuConfig.defineMenu("File", "New...;|;Open...;@Open Recent;|;Open From Server...;|;Compare...;|;Import From BLAST...;@Import;|;"
        ...
        menuConfig.defineMenu("Edit", "Cut;Copy;Paste;|;Find...;Find Again;");
    ...
    public static String getToolBarConfiguration() {
        return "Open...;Print...;Export Image...;|;Find...;|;" +
                "Chart Microbial Attributes...;|;Sort Taxa Alphabetically;Sort Taxa Numerically;|;" +
                "Main Viewer...;" + ClassificationCommandHelper.getOpenViewerMenuString() + "|;Samples Viewer...;|;" +
                "Open NCBI Webpage Attributes;";
    }
}
