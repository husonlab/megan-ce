/*
 * ExtractReadsViewer.java Copyright (C) 2024 Daniel H. Huson
 *
...
public class ExtractReadsViewer extends JFrame implements IDirectableViewer {
    ...
    public ExtractReadsViewer(JFrame parent, final Director dir) {
        ...
        outFileTemplate.setToolTipText("Set name of file to save to. Occurrences of %f, %t, or %i, will be replaced by the input file name, class name or id, respectively");
