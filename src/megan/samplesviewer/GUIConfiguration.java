...
class GUIConfiguration {
    ...
    public static MenuConfiguration getMenuConfiguration() {
        ...
        menuConfig.defineMenu("Samples", "Rename Sample...;|;Move Up;Move Down;|;Extract Samples...;|;Compute Total Biome...;Compute Core Biome...;Compute Rare Biome...;|;Remove Low Abundances...;|;Compare Relative...;Compare Absolute...;Split By Attribute...;|;Label by Samples;|;Open RMA File...;");
    ...
    public static String getSampleRowHeaderPopupConfiguration() {
        return "Move Up;Move Down;|;Rename Sample...;|;Open RMA File...;|;Set Shape...;Set Color...;"; // we add the color menu item after these
    }
