/*
 * ShapeSamplesByCommand.java Copyright (C) 2023 Daniel H. Huson
 *
...
public class ShapeSamplesByCommand extends CommandBase implements ICommand {
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        if (attribute != null)
            execute("shapeBy attribute='" + attribute + "';");
    }
    ...
    public String getName() {
        return "Use to Shape Samples";
    }

    public String getDescription() {
        return "Shape samples by this attribute";
    }
