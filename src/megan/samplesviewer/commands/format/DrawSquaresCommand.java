/*
 * DrawSquaresCommand.java Copyright (C) 2021. Daniel H. Huson
 *
...
public class DrawSquaresCommand extends CommandBase implements ICommand {
    ...
    public ImageIcon getIcon() {
        return ResourceManager.getIcon("BlueSquare16.gif");
    }
    ...
    public void actionPerformed(ActionEvent ev) {
        ...
        if (samples.size() > 0)
			execute("set nodeShape=square sample='" + StringUtils.toString(samples, "' '") + "';");
    }
