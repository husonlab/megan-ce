/*
 * ReadExtractorTool.java Copyright (C) 2023 Daniel H. Huson
 *
    ...
    private void run(String[] args) throws UsageException, IOException {
        ...
        for (int i = 0; i < inputFiles.size(); i++) {
            ...
            try {
                ...
                if (ignoreExceptions)
                    System.err.println(Basic.getShortName(ex.getClass()) + ": " + (ex.getMessage() != null ? ex.getMessage() : ex.toString()) + ", while processing file: " + inputFile);
                else
                    throw ex;
            }
        }
