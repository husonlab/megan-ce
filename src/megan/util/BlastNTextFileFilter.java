/*
 * BlastNTextFileFilter.java Copyright (C) 2024 Daniel H. Huson
 *
 ...
 * Daniel Huson         4.2015
 */
public class BlastNTextFileFilter extends FileFilterBase implements FilenameFilter {
    static private BlastNTextFileFilter instance;

    public static BlastNTextFileFilter getInstance() {
        if (instance == null) {
            instance = new BlastNTextFileFilter();
