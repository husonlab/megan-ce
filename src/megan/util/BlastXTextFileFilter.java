/*
 * BlastXTextFileFilter.java Copyright (C) 2022 Daniel H. Huson
 *
 ...
 * Daniel Huson         4.2015
 */
public class BlastXTextFileFilter extends FileFilterBase implements FilenameFilter {
    static private BlastXTextFileFilter instance;

    public static BlastXTextFileFilter getInstance() {
        if (instance == null) {
            instance = new BlastXTextFileFilter();
